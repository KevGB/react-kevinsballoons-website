  ...
  return (
    <div className="scrolling-gallery-container">
      <div className="scrolling-gallery">
        <img src={garland50} alt="" className="initiate-scroll" />
        <img src={duck} alt="" />
        <img src={columns} alt="" />
        <img src={owl} alt="" />
