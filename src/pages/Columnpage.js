    ...
    >
      <CardBody>
        <p className="service-description ">
          ...
          that's sure to impress your guests. They add visual interest and depth to your
          event, whether you're celebrating a birthday, a wedding, or sports event, a balloon column can help create a
          festive and inviting atmosphere. You can choose from a
          wide range of colors, patterns, and sizes, whether you
          want something bright and bold, or more understated and elegant,
          there's a balloon column out there that's perfect for you. 
          Choose either a Quad or Organic style. Make sure
          you ask Kevin to add some of his famous balloon twisting designs to
          make your columns 1 of a kind! Whether you're looking to add a pop of color to your decor,
      ...
      <CardBody>Arches can be short or tall, but they always stand alone</CardBody>
